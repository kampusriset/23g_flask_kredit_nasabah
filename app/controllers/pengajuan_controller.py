...
def index():
    ...
    return render_template('pengajuan.html', pengajuan=pengajuan, pagination=pagination,
...
def detail(id):
    ...
    return render_template('detail_pengajuan.html', pengajuan=pengajuan)
...
def setujui(id):
    ...
    return render_template('pengajuan_action.html', form=form, pengajuan=pengajuan, action='Setujui')
...
def tolak(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('pengajuan.index'))
    return render_template('pengajuan_action.html', form=form, pengajuan=pengajuan, action='Tolak')
...
def survei(id):
    ...
    return render_template('survei_form.html', pengajuan=pengajuan)
...
def jadwal_survei():
    ...
    return render_template('jadwal_survei.html', pengajuan_survei=pengajuan_survei, today=today, week_later=week_later,
...
def ajukan():
    ...
    return render_template('pengajuan_nasabah_form.html', form=form)
